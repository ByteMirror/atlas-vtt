...
- Ctrl/Cmd no longer reopens a note or statblock preview from a map you have left. After switching scenes, following a link or moving to another Obsidian tab, the hovered pin or token is forgotten.

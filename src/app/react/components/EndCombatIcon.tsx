...
/** Truce by Delapouite from game-icons.net (CC BY 3.0), from the same set as the widget icons. */
const TRUCE_PATH =
...
/** White flag for ending combat; sized by the surrounding CSS like the Lucide icons next to it. */
export function EndCombatIcon(): React.ReactElement {
  return (
    <svg viewBox={WIDGET_ICON_VIEW_BOX} fill="currentColor" aria-hidden="true">
      <path d={TRUCE_PATH} />
    </svg>
  );
}
